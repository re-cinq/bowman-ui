 ...
 * and web-ui is skipped entirely — it cannot import `the unpublished shared package`.
 */
...
const PACKAGE_SOURCE = "the unpublished shared package/lib/enforce.js";
...
export default {
  ...
  create(context) {
    // web-ui cannot import the unpublished shared package (it is not a workspace and
