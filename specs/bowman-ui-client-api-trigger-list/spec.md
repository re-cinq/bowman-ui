...
- **Coverage narrowed versus the old text matcher in exactly one known shape**: a destructured
  namespace, `const { useState } = React`, is a declaration name and no longer fires. It does
