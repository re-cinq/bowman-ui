...
([validated by](../../tests/client-directives.test.ts#L12)). A source-direction file that
...
([validated by](../../tests/client-directives.test.ts#L109)).

### The four rules

1. **Hook-shaped import, any module specifier.**
   - A named or default import whose imported or local name matches
     `/^use[A-Z]/` ([validated by](../../tests/client-directives.test.ts#L12),
     [L20](../../tests/client-directives.test.ts#L20)).
   - This includes a relative specifier - the clause that carries the widening
     ([validated by](../../tests/client-directives.test.ts#L30)).
   - A hook-shaped **member access** (`React.useState`, called or passed as a
     value) also fires
     ([validated by](../../tests/client-directives.test.ts#L42)).
...
2. **Named import of `createContext`**, imported or local name, the same type-only exclusion,
   ...
   terms ([validated by](../../tests/client-directives.test.ts#L52)).
3. **Class heritage `Component`/`PureComponent`**, bare or through a namespace import - both
   shapes pinned in one fixture ([validated by](../../tests/client-directives.test.ts#L65)).
   ...
   - Value references inside a mixin expression
     ...
     ([validated by](../../tests/client-directives.test.ts#L65)).
4. **Value-position browser-global reference** from the measured list below
   ([validated by](../../tests/client-directives.test.ts#L79)).
   - It includes a `typeof window` guard
     ([validated by](../../tests/client-directives.test.ts#L89)).
   ...
   - Type positions never fire; DOM type names are excluded outright (below;
     [validated by](../../tests/client-directive-trigger-list.test.ts#L47)).

The `on[A-Z]` JSX-handler trigger fires off `JsxAttribute` nodes, an attribute node being the
only shape that fires ([validated by](../../tests/client-directives.test.ts#L99)). The same name
inside a line comment, block comment, or string literal does not fire
([validated by](../../tests/client-directives.test.ts#L109)). The root barrel `src/index.ts`
...
([validated by](../../tests/client-directives.test.ts#L109)). The full run against
`src/` and `dist/` pins it too ([validated by](../../tests/client-directives.test.ts#L115)).
...
([validated by](../../tests/client-directive-trigger-list.test.ts#L24)). Probed defined and
...
in-repo evidence ([validated by](../../tests/client-directive-trigger-list.test.ts#L47)).
...
expected count held ([validated by](../../tests/client-directives.test.ts#L115)).
