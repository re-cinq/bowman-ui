...
([validated by](../../tests/client-directives.test.ts#L84)).
...
1. **Hook-shaped import, any module specifier.**
   ...
   - A hook-shaped **member access** (`React.useState`, called or passed as a
     value) also fires
     ([validated by](../../tests/client-directives.test.ts#L33)).
...
2. **Named import of `createContext`**, imported or local name, the same type-only exclusion,
   ...
   terms ([validated by](../../tests/client-directives.test.ts#L41)).
3. **Class heritage `Component`/`PureComponent`**, bare or through a namespace import - both
   shapes pinned in one fixture ([validated by](../../tests/client-directives.test.ts#L50)).
...
4. **Value-position browser-global reference** from the measured list below
   ([validated by](../../tests/client-directives.test.ts#L60)).
   ...
   - Type positions never fire; DOM type names are excluded outright (below;
     [validated by](../../tests/client-directive-trigger-list.test.ts#L40)).

The `on[A-Z]` JSX-handler trigger fires off `JsxAttribute` nodes, an attribute node being the
only shape that fires ([validated by](../../tests/client-directives.test.ts#L76)). The same name
inside a line comment, block comment, or string literal does not fire
([validated by](../../tests/client-directives.test.ts#L84)). The root barrel `src/index.ts`
...
([validated by](../../tests/client-directives.test.ts#L84)). The full run against
`src/` and `dist/` pins it too ([validated by](../../tests/client-directives.test.ts#L90)).
...
([validated by](../../tests/client-directive-trigger-list.test.ts#L17)). Probed defined and
...
in-repo evidence ([validated by](../../tests/client-directive-trigger-list.test.ts#L40)).
...
expected count held ([validated by](../../tests/client-directives.test.ts#L90)).
