...
so leading comments stay allowed - whenever any trigger fires. A source-direction file that
...
`dist/` ([validated by](../../tests/client-directives.test.ts#L80)), so no file gains
