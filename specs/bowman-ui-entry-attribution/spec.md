...
7. **The name line is the only authorship assistive technology gets.** The
   ...
   [with an avatar supplied](../../tests/ChatMessage.test.tsx#L562),
   [L519](../../tests/ChatMessage.test.tsx#L519)).
...
([validated by](../../tests/ChatMessage.test.tsx#L533),
[L546](../../tests/ChatMessage.test.tsx#L546)).
