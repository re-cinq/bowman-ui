...
filter ([validated by no run of three Latin letters survives outside the sentinels for any labelsProp member](../../tests/labelled-exports.test.tsx#L638)). The
...
[L346](../../tests/labelled-exports.test.tsx#L346),
