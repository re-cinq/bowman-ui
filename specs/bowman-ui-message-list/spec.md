...
`ChatMessage`'s own
([validated by](../../tests/ChatMessageList.test.tsx#L220),
[markdown](../../tests/ChatMessageList.test.tsx#L248),
[avatar](../../tests/ChatMessageList.test.tsx#L266)). Entries render in
...
([validated by](../../tests/ChatMessageList.test.tsx#L198),
[keys](../../tests/ChatMessageList.test.tsx#L281)). Seventeen fields in
...
([validated by](../../tests/ChatMessageList.test.tsx#L185)).
...
([validated by](../../tests/types/chat-message-list-type-assertions.tsx#L58),
[no-default](../../tests/types/chat-message-list-type-assertions.tsx#L35),
compiled by
...
default ([validated by](../../tests/ChatMessageList.test.tsx#L178)).
...
2. **Auto-scroll follows the bottom only while the reader is pinned.**
   ...
   ([validated by](../../tests/ChatMessageList.test.tsx#L350),
   [L353](../../tests/ChatMessageList.test.tsx#L367),
   [append while pinned](../../tests/ChatMessageList.test.tsx#L334)), and
   the 32px threshold is pinned at both sides of the boundary
   ([validated by](../../tests/ChatMessageList.test.tsx#L471)). One
   ...
   ([validated by](../../tests/ChatMessageList.test.tsx#L497)). Mount
   always scrolls to the latest message unconditionally, instant, before
   any scroll event
   ([validated by](../../tests/ChatMessageList.test.tsx#L430)).
3. **Smooth on append, instant on delta, always instant under reduced
   ...
   forces `"auto"` always
   ([validated by](../../tests/ChatMessageList.test.tsx#L386),
   [L391](../../tests/ChatMessageList.test.tsx#L405)). A delta must arrive
   ...
   fold ([validated by](../../tests/ChatMessageList.test.tsx#L441)).
4. **`scrollTo` with a `scrollTop` fallback, never `scrollIntoView`.**
   ...
   ([validated by](../../tests/ChatMessageList.test.tsx#L456)).
5. **The handle is the consumer's escape hatch.**
   ...
   ([validated by](../../tests/ChatMessageList.test.tsx#L557),
   [L574](../../tests/ChatMessageList.test.tsx#L588)).
   `isPinnedToBottom()` measures the live geometry rather than replaying
   the last scroll event
   ([validated by](../../tests/ChatMessageList.test.tsx#L536)) - which
...
6. **The transcript is `role="log"` with `aria-live="off"`.** The role's
   ...
   accessible name
   ([validated by](../../tests/ChatMessageList.test.tsx#L627)).
   ...
   true ([validated by](../../tests/ChatMessageList.test.tsx#L641),
...
8. **`busy` renders exactly one `ThinkingIndicator`, after the last
   ...
   ([validated by](../../tests/ChatMessageList.test.tsx#L298),
   [L298](../../tests/ChatMessageList.test.tsx#L312),
   [L304](../../tests/ChatMessageList.test.tsx#L318)). When to set `busy`
...
- No `@clerk`, `swr`, `next-intl`, `next/`, `@discovery`, `@/` or
  ...
  ([validated by](../../tests/ChatMessageList.test.tsx#L660)).
- **GDPR.** The rendered entries are customer questions carrying booking
  ...
  ([validated by](../../tests/ChatMessageList.test.tsx#L669)); the
...
- **Not in scope**, per the issue: a jump-to-latest button, an
  ...
  the load-error/retry block, virtualisation, and every Danish string - the
