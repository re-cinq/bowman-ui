...
([validated by](../../examples/chat-demo/tests/chat-demo.spec.ts#L299)),
measuring the really rendered box via `getBoundingClientRect().height`
([validated by](../../examples/chat-demo/tests/chat-demo.spec.ts#L304)) -
...
([validated by](../../examples/chat-demo/tests/chat-demo.spec.ts#L322),
[L323](../../examples/chat-demo/tests/chat-demo.spec.ts#L323)). A baseline of
`0` fails with a message naming the Marginalia Books demo screen
([validated by](../../examples/chat-demo/tests/chat-demo.spec.ts#L321)).
...
[L358](../../examples/chat-demo/tests/chat-demo.spec.ts#L358)) rather than
...
([validated by](../../examples/chat-demo/tests/chat-demo.spec.ts#L339)) leave
the draft in the box - the surviving value `draft + "\n\n\n"` is the
load-bearing no-send assertion, because `submit()` clears the value on any
send ([validated by](../../examples/chat-demo/tests/chat-demo.spec.ts#L343)).
The user-entry count staying at four corroborates it
([validated by](../../examples/chat-demo/tests/chat-demo.spec.ts#L346)), and
the measured height ends strictly greater than the baseline
([validated by](../../examples/chat-demo/tests/chat-demo.spec.ts#L347)) - the
...
exactly `200`
([validated by](../../examples/chat-demo/tests/chat-demo.spec.ts#L362)) -
`027`'s `maxHeightPx` default - and filling twenty-four lines instead leaves
it at exactly `200`
([validated by](../../examples/chat-demo/tests/chat-demo.spec.ts#L366)). The
...
([validated by](../../examples/chat-demo/tests/chat-demo.spec.ts#L361),
[L365](../../examples/chat-demo/tests/chat-demo.spec.ts#L365),
[L337](../../examples/chat-demo/tests/chat-demo.spec.ts#L337)): the button
...
([validated by](../../examples/chat-demo/tests/chat-demo.spec.ts#L368)) - a
...
([validated by](../../examples/chat-demo/tests/chat-demo.spec.ts#L376)) and
`scrollTop > 0`
([validated by](../../examples/chat-demo/tests/chat-demo.spec.ts#L377)).
...
five ([validated by](../../examples/chat-demo/tests/chat-demo.spec.ts#L384)),
the sent entry contains the unique final line `Invented line 24 of 24`
([validated by](../../examples/chat-demo/tests/chat-demo.spec.ts#L385)) (a
line-number sentinel is avoided as a prefix trap: `Line 1` would also match
`Line 10`), the composer's value is `""`
([validated by](../../examples/chat-demo/tests/chat-demo.spec.ts#L386)) so
...
([validated by](../../examples/chat-demo/tests/chat-demo.spec.ts#L387)).
...
baseline
([validated by](../../examples/chat-demo/tests/chat-demo.spec.ts#L387)). The
...
([validated by](../../tests/ChatComposer.test.tsx#L255)) and reaching `320px`
with `maxHeightPx={400}`
([validated by](../../tests/ChatComposer.test.tsx#L264)) - and by no browser.
...
([validated by](../../examples/chat-demo/tests/chat-demo.spec.ts#L333)) and
