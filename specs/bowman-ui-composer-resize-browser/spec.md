...
([validated by](../../examples/chat-demo/tests/chat-demo.spec.ts#L284),
[L289](../../examples/chat-demo/tests/chat-demo.spec.ts#L289)). No file under
...
cited file
([validated by maps a link into README.md, titled or not, from L2 to L3 through the hunks](../../tests/reanchor-spec-links.test.ts#L283)). The
...
([validated by the empty composer measures above 0 and below the 200px cap](../../examples/chat-demo/tests/chat-demo.spec.ts#L304),
[validated by the empty composer measures above 0 and below the 200px cap](../../examples/chat-demo/tests/chat-demo.spec.ts#L305)). A baseline of
`0` fails with a message naming the Marginalia Books demo screen
([validated by the empty composer measures above 0 and below the 200px cap](../../examples/chat-demo/tests/chat-demo.spec.ts#L303)).
...
([validated by](../../examples/chat-demo/tests/chat-demo.spec.ts#L323),
[L319](../../examples/chat-demo/tests/chat-demo.spec.ts#L319)). The
...
[L327](../../examples/chat-demo/tests/chat-demo.spec.ts#L327)).
...
[L340](../../examples/chat-demo/tests/chat-demo.spec.ts#L340)). The
...
the DOM value
([validated by](../../examples/chat-demo/tests/chat-demo.spec.ts#L339),
[L343](../../examples/chat-demo/tests/chat-demo.spec.ts#L343),
[L318](../../examples/chat-demo/tests/chat-demo.spec.ts#L318)).
...
([validated by](../../examples/chat-demo/tests/chat-demo.spec.ts#L346),
[L354](../../examples/chat-demo/tests/chat-demo.spec.ts#L354),
[L355](../../examples/chat-demo/tests/chat-demo.spec.ts#L355)). No assertion
...
([validated by](../../examples/chat-demo/tests/chat-demo.spec.ts#L363),
[L360](../../examples/chat-demo/tests/chat-demo.spec.ts#L360),
[L361](../../examples/chat-demo/tests/chat-demo.spec.ts#L361),
[L362](../../examples/chat-demo/tests/chat-demo.spec.ts#L362)).
...
baseline
([validated by](../../examples/chat-demo/tests/chat-demo.spec.ts#L363)). The
...
([validated by a stubbed scrollHeight of 320 caps the height at 200px under the default maxHeightPx](../../tests/ChatComposer.test.tsx#L305),
[validated by the same 320 becomes 320px with maxHeightPx={400}](../../tests/ChatComposer.test.tsx#L314)). The demo pins its
...
([validated by](../../examples/chat-demo/tests/chat-demo.spec.ts#L315),
[L291](../../examples/chat-demo/tests/chat-demo.spec.ts#L291)). The generated
...
([job](../../.github/workflows/ci.yml#L134)). No new job, no second browser
