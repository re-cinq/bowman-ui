...
single `"."` entry ([validated by](../../tests/icons-dist.test.ts#L54)). `src/icons/index.tsx` exports exactly 23 icon components,
enumerated by name so a dropped icon fails the build rather than the consumer
([validated by](../../tests/icons.test.tsx#L67)). Path data is pinned
...
([validated by](../../tests/icons.test.tsx#L190), oracle at
...
([validated by](../../tests/icons.test.tsx#L80)). The factory stamps each
...
([validated by](../../tests/icons.test.tsx#L405)). Each root
`<svg>` carries
`fill="none"`, `viewBox="0 0 24 24"` and, for the 22, `stroke="currentColor"`
([validated by](../../tests/icons.test.tsx#L158),
[L171](../../tests/icons.test.tsx#L171)). `forwardRef` stays exactly as-is per
...
([validated by](../../tests/icons-dist.test.ts#L54)).
...
it through ([validated by](../../tests/icons.test.tsx#L331),
[L343](../../tests/icons.test.tsx#L343)). The would-be regression is pinned: no root `stroke` attribute,
`class` containing `animate-spin`, `<path fill="currentColor">` with no stroke
([validated by](../../tests/icons.test.tsx#L324)). `animate-spin` is a Tailwind
...
the installed `dist` ([validated by](../../tests/icons.test.tsx#L150)).
...
not touch it ([validated by](../../tests/icons.test.tsx#L302),
[L307](../../tests/icons.test.tsx#L307)).
...
([validated by](../../tests/icons-dist.test.ts#L54)). A
...
([validated by](../../tests/icons-dist.test.ts#L54), assertions at
...
component
([validated by](../../tests/icons.test.tsx#L94)).
...
([validated by](../../tests/icons.test.tsx#L67)).
All four resolve through the `"."` exports entry
([validated by](../../tests/icons-dist.test.ts#L54)). `npm pack --dry-run`
ships `dist/icons/Icon.{js,d.ts}` and `dist/icons/index.{js,d.ts}`
([validated by](../../tests/icons-dist.test.ts#L79)).
...
([validated by](../../tests/icons.test.tsx#L205),
[L223](../../tests/icons.test.tsx#L223),
[L241](../../tests/icons.test.tsx#L241),
[L255](../../tests/icons.test.tsx#L255),
[L271](../../tests/icons.test.tsx#L271),
[L285](../../tests/icons.test.tsx#L285)). The
`getAttribute`-based class assertions work around `SVGAnimatedString`
([validated by](../../tests/icons.test.tsx#L315),
[L384](../../tests/icons.test.tsx#L384)).

`strokeWidth` defaults to `2` and reaches both the `<svg>` and the `<path>`
([validated by](../../tests/icons.test.tsx#L351)).
`<SearchIcon strokeWidth={1.5} />` renders `stroke-width="1.5"` on the path
([validated by](../../tests/icons.test.tsx#L361)). `DatabaseIcon` defaults to
`1.5` ([validated by](../../tests/icons.test.tsx#L370)).
...
mark ([validated by](../../tests/icons.test.tsx#L86)). `grep -rn "LogoIcon" src/` returns nothing
([validated by](../../tests/icons.test.tsx#L86)). The README points a
consumer wanting a brand mark at the `assistantAvatar` slot from `docs/design-notes.md`
([validated by](../../tests/icons.test.tsx#L123)).

## Client boundary

No file under `src/icons/` carries `"use client"` - the icons use no
client-only React API
([validated by](../../tests/icons.test.tsx#L144)). `scripts/check-client-directives.mjs`
passes against every file under `src/icons/`, per docs/design-notes.md
decision 1
([validated by](../../tests/client-directives.test.ts#L115)).
Every relative import under `src/icons/` ends in `.js` and no file contains
`"@/` ([validated by](../../tests/icons.test.tsx#L130)).
