...
past-tense one
([validated by](../../tests/ToolActivity.test.tsx#L108)). The published
...
([validated by](../../tests/ToolActivity.test.tsx#L267)) - `dist/index.d.ts`
...
1. **The parameter is additive, not a break.** TypeScript's contravariance on
   ...
   ([validated by](../../tests/ToolActivity.test.tsx#L133)), and
   `tests/types/tool-activity-type-assertions.tsx` compiles against the built
   package suppressing no error
   ([validated by](../../tests/ToolActivity.test.tsx#L285)). The same
   one-parameter shape stays pinned through `ChatMessageList`'s own assertions
   ([validated by](../../tests/types/chat-message-list-type-assertions.tsx#L94),
   compiled by
   [chat-message-list-dist](../../tests/chat-message-list-dist.test.ts#L32)).
2. **One source of truth for the flag.** The value passed is the prop
   ...
   ([validated by](../../tests/ChatMessageList.test.tsx#L821)). Its prop type
...
3. **Replacement semantics are untouched.** A supplied `describeTool` still
   ...
   ([validated by](../../tests/ToolActivity.test.tsx#L83)). This issue changes
