...
README's App Router consumer section ([validated by](../../README.md#L212)).
...
([validated by](../../docs/design-notes.md#L894)), and the same sentence appears in
...
refusal and its reason ([validated by](../../docs/design-notes.md#L874)).
...
- docs/design-notes.md decision 4's "not a dependency anywhere" bullet names
  ...
  where `next` may appear ([validated by](../../docs/design-notes.md#L864)).
