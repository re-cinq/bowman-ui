...
([validated by](../../.github/workflows/ci.yml#L159)) - the issue text
...
`build: "true"` ([validated by](../../.github/workflows/ci.yml#L167)), an explicit
...
([validated by](../../.github/workflows/ci.yml#L168),
[the red step](../../.github/workflows/ci.yml#L170)).

The same job re-runs the three next-absence checks, unmodified:
`check-forbidden-imports.mjs`
([validated by](../../.github/workflows/ci.yml#L172)), `018`'s manifest grep
with the `node_modules/next` probe
([validated by](../../.github/workflows/ci.yml#L174)), and `032`'s
...
([validated by](../../.github/workflows/ci.yml#L185)). One honest caveat,
