...
([validated by](../../tests/ThinkingIndicator.test.tsx#L121)).
...
([validated by](../../tests/ThinkingIndicator.test.tsx#L37)). A key added
without a default fails the build, pinned from outside by an
`@ts-expect-error` fixture
([validated by](../../tests/types/thinking-indicator-type-assertions.tsx#L22),
compiled by
[thinking-indicator-dist](../../tests/thinking-indicator-dist.test.ts#L29)).
...
([validated by](../../tests/types/thinking-indicator-type-assertions.tsx#L13)).
...
([validated by](../../tests/system-contract.test.ts#L38)).
...
1. **Both strings are overridable.** A hardcoded `aria-label` competes with
   ...
   - With Danish overrides neither English string appears anywhere in the
     rendered output
     ([validated by](../../tests/ThinkingIndicator.test.tsx#L23)).
...
2. **The avatar slot is the glyph, not the circle** (018 decision 3).
   - `assistantAvatar` renders inside the circle
     ([validated by](../../tests/ThinkingIndicator.test.tsx#L50)).
   - With none supplied the circle is empty
     ([validated by](../../tests/ThinkingIndicator.test.tsx#L64)).
   - `LogoIcon` appears nowhere in `src/` or `dist/`
     ([validated by](../../tests/ThinkingIndicator.test.tsx#L158)).
3. **The circle is unconditionally `aria-hidden` and unconditionally
   ...
   either off ([validated by](../../tests/ThinkingIndicator.test.tsx#L73)).
   ...
   ([validated by](../../tests/ThinkingIndicator.test.tsx#L73)).
...
4. **One dots implementation, one dots assertion.** `ThinkingDots` owns the
   ...
   - Both components import it
     ([validated by](../../tests/ThinkingIndicator.test.tsx#L140)).
   - One shared test helper
     ...
     ([validated by](../../tests/ThinkingIndicator.test.tsx#L45),
     [inline](../../tests/InlineThinkingIndicator.test.tsx#L23)).
   - `InlineThinkingIndicator` still renders its label and dots with no
     `role="status"` and no avatar circle
     ([validated by](../../tests/ThinkingIndicator.test.tsx#L86)).

## The 015 characterization suite, substituted

No prior characterization suite existed for this surface (Otto#9), so the
tests are
...
([validated by](../../tests/ThinkingIndicator.test.tsx#L45)). The circle
carries `bowman-pulse-subtle`, not `animate-pulse-subtle`
([validated by](../../tests/ThinkingIndicator.test.tsx#L73)). One path correction: the labels partition lives
...
([validated by](../../tests/ThinkingIndicator.test.tsx#L45),
[L73](../../tests/ThinkingIndicator.test.tsx#L73)).
...
- Both new files carry `"use client"` as the first statement of their `dist/`
  ...
  ([validated by](../../tests/thinking-indicator-dist.test.ts#L11)).
- Neither file references a client-only API today; docs/design-notes.md decision 1's
  ...
  precedent ([validated by](../../tests/thinking-indicator-dist.test.ts#L11)).
- **GDPR.** The component renders only its own labels - no customer data
  ...
  - Neither file references `console.`, `localStorage`, `sessionStorage`,
    `fetch` or `sendBeacon`
    ([validated by](../../tests/ThinkingIndicator.test.tsx#L150)).
...
- `npm pack --dry-run` ships both built files with their `d.ts` counterparts
  ([validated by](../../tests/thinking-indicator-dist.test.ts#L20)).
...
([validated by](../../tests/ThinkingIndicator.test.tsx#L169)).
