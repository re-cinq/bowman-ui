...
([validated by exports exactly the eight chat type names](../../tests/types/chat.test.ts#L124)). It is a
...
([validated by declares no property named index, devMetadata, correlationId, traceId, timings, reflection, scores, tenantId, organizationId or timestamp](../../tests/types/chat.test.ts#L100)). The exported names are
disjoint from `hal-engine/src/types/index.ts`'s exports so `support-agent` can
import both packages in one adapter file
([validated by no name exported by src/types/chat.ts appears in hal-engine's exports](../../tests/types/chat.test.ts#L155)).
...
([validated by exports exactly the eight chat type names](../../tests/types/chat.test.ts#L124)). A fifth role does not
...
protocol counterpart ([validated by declares no property named index, devMetadata, correlationId, traceId, timings, reflection, scores, tenantId, organizationId or timestamp](../../tests/types/chat.test.ts#L100),
[validated by declares no index signature](../../tests/types/chat.test.ts#L120)). Its sibling
...
([validated by is absent or contains no statement other than export {}](../../tests/types/chat.test.ts#L243)).
...
([validated by maps the user example to a UserChatEntry, dropping only timestamp](../../tests/types/chat.test.ts#L189),
[validated by maps the assistant example to an AssistantChatEntry, dropping only timestamp](../../tests/types/chat.test.ts#L200),
[validated by maps the thinking example to a ThinkingChatEntry with every field surviving](../../tests/types/chat.test.ts#L212),
[validated by maps the tool example to a ToolChatEntry with every field surviving and no content](../../tests/types/chat.test.ts#L224),
[validated by keeps the mapping function out of the published surface - dist/index.d.ts has no such symbol](../../tests/types/chat.test.ts#L237)).
...
- **Fixture wrapper**: `tests/fixtures/hal-session-entries.json` keeps the four
  ...
  ([validated by `carries the four examples verbatim, with provenance in _meta`](../../tests/types/chat.test.ts#L161)).
