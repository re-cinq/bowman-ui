...
([validated by](../../tests/types/chat.test.ts#L118)). A fifth role does not
...
([validated by](../../tests/types/chat.test.ts#L232)).
...
([validated by](../../tests/types/chat.test.ts#L182),
[L192](../../tests/types/chat.test.ts#L192),
[L203](../../tests/types/chat.test.ts#L203),
[L214](../../tests/types/chat.test.ts#L214),
[L226](../../tests/types/chat.test.ts#L226)).
...
- **Fixture wrapper**: `tests/fixtures/hal-session-entries.json` keeps the four
  ...
  ([validated by](../../tests/types/chat.test.ts#L154)).
...
- **Type-level assertions**: `npm run typecheck` only covers `src/`, so the
  ...
  ([validated by](../../tests/types/chat.test.ts#L71)).
