...
([validated by](../../tests/types/chat.test.ts#L160)). It is a
...
([validated by](../../tests/types/chat.test.ts#L160)). A fifth role does not
typecheck, and an `AssistantChatEntry` without `isStreaming` does not compile
([validated by](../../tests/types/chat.test.ts#L107)). No exported type declares
`index`, `devMetadata`, `correlationId`, `traceId`, `timings`, `reflection`,
`scores`, `tenantId`, `organizationId`, `timestamp` or an index signature
([validated by](../../tests/types/chat.test.ts#L132),
[L154](../../tests/types/chat.test.ts#L154)).
...
([validated by](../../tests/types/chat.test.ts#L295)).
...
([validated by](../../tests/types/chat.test.ts#L226),
[L240](../../tests/types/chat.test.ts#L240),
[L257](../../tests/types/chat.test.ts#L257),
[L273](../../tests/types/chat.test.ts#L273),
[L289](../../tests/types/chat.test.ts#L289)).
...
- **Fixture wrapper**: `tests/fixtures/hal-session-entries.json` keeps the four
  ...
  ([validated by](../../tests/types/chat.test.ts#L197)).
...
- **Type-level assertions**: `npm run typecheck` only covers `src/`, so the
  ...
  ([validated by](../../tests/types/chat.test.ts#L107)).
