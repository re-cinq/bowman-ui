...
consumer put on it
([validated by](../../tests/ChatMessageList.test.tsx#L305)). Because the
...
2. **The callback runs for every rendered entry, user rows included.**
   ...
   gets no call ([validated by](../../tests/ChatMessageList.test.tsx#L327)).
   ...
   `ChatMessage` ([validated by](../../tests/ChatMessageList.test.tsx#L345)).
3. **Omitting the prop and returning `undefined` are the same render.**
   ...
   ([validated by](../../tests/ChatMessageList.test.tsx#L360)).
...
- **EU AI Act.** No value of `renderEntryFooter` removes, covers or
  ...
  region ([validated by](../../tests/ChatMessageList.test.tsx#L379)), and
  ...
  ([validated by](../../tests/ChatMessageList.test.tsx#L156)).
