...
consumer put on it
([validated by](../../tests/ChatMessageList.test.tsx#L381)). Because the
...
1. **The parameter type is written out, never derived from `entries`.**
   ...
   ([validated by](../../tests/types/chat-message-list-type-assertions.tsx#L83),
...
2. **The callback runs for every rendered entry, user rows included.**
   ...
   gets no call ([validated by](../../tests/ChatMessageList.test.tsx#L408)).
   ...
   `ChatMessage` ([validated by](../../tests/ChatMessageList.test.tsx#L431)).
3. **Omitting the prop and returning `undefined` are the same render.**
   ...
   ([validated by](../../tests/ChatMessageList.test.tsx#L447)).
...
- **EU AI Act.** No value of `renderEntryFooter` removes, covers or
  ...
  region ([validated by](../../tests/ChatMessageList.test.tsx#L471)), and
  ...
  ([validated by](../../tests/ChatMessageList.test.tsx#L192)).
- **GDPR.** A footer may carry customer-derived content (a score computed
  ...
  ([validated by](../../tests/ChatMessageList.test.tsx#L1222)), and a
  rerender without the prop leaves no footer behind
  ([validated by](../../tests/ChatMessageList.test.tsx#L487)). The
