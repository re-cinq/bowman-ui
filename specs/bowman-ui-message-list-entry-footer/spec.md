...
consumer put on it
([validated by](../../tests/ChatMessageList.test.tsx#L315)). Because the
...
2. **The callback runs for every rendered entry, user rows included.**
   ...
   gets no call ([validated by](../../tests/ChatMessageList.test.tsx#L337)).
   ...
   `ChatMessage` ([validated by](../../tests/ChatMessageList.test.tsx#L355)).
3. **Omitting the prop and returning `undefined` are the same render.**
   ...
   ([validated by](../../tests/ChatMessageList.test.tsx#L370)).
...
- **EU AI Act.** No value of `renderEntryFooter` removes, covers or
  ...
  region ([validated by](../../tests/ChatMessageList.test.tsx#L389)), and
...
- **GDPR.** A footer may carry customer-derived content (a score computed
  ...
  ([validated by](../../tests/ChatMessageList.test.tsx#L933)), and a
  rerender without the prop leaves no footer behind
  ([validated by](../../tests/ChatMessageList.test.tsx#L404)). The
