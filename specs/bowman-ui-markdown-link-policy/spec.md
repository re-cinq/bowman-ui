...
`src/` ([validated by](../../tests/markdown/urlPolicy.test.tsx#L329)).
...
rejects everything
([validated by](../../tests/markdown/urlPolicy.test.tsx#L100)).
`allowRelativeUrls: true` renders `<a href="/booking/42">`; the default does
not ([validated by](../../tests/markdown/urlPolicy.test.tsx#L111),
[L119](../../tests/markdown/urlPolicy.test.tsx#L119)).

## Anchor hardening

Every rendered anchor carries `rel="noopener noreferrer"` and
`target="_blank"`
([validated by](../../tests/markdown/urlPolicy.test.tsx#L135)). With
...
header ([validated by](../../tests/markdown/urlPolicy.test.tsx#L150)). A
...
absent under `_self`
([validated by](../../tests/markdown/urlPolicy.test.tsx#L161),
[L172](../../tests/markdown/urlPolicy.test.tsx#L172),
[L186](../../tests/markdown/urlPolicy.test.tsx#L186)). The notice class is
...
by](../../tests/markdown/urlPolicy.test.tsx#L244)). It renders the anchor with
the `rel` pair and the notice under the `["https", "http"]` opt-in
([validated by](../../tests/markdown/urlPolicy.test.tsx#L253)). Silently
...
default ([validated by](../../tests/markdown/urlPolicy.test.tsx#L272)).
...
[L291](../../tests/markdown/urlPolicy.test.tsx#L291)).
...
([validated by](../../tests/markdown/urlPolicy.test.tsx#L302)). Suite-wide,
...
([validated by](../../tests/markdown/urlPolicy.test.tsx#L337)). Raw HTML
still renders as escaped text - no `rehype` anywhere
([validated by](../../tests/markdown/urlPolicy.test.tsx#L329)).
...
([validated by](../../tests/markdown-components.test.tsx#L76)). The
...
`ReactMarkdown` ([validated by](../../tests/ChatMessage.test.tsx#L910),
[L943](../../tests/ChatMessage.test.tsx#L943),
[L958](../../tests/ChatMessage.test.tsx#L958)). A rejected link renders as a
span ([validated by](../../tests/ChatMessage.test.tsx#L930)). An image
renders as alt text
([validated by](../../tests/ChatMessage.test.tsx#L985)). The
`linkOpensInNewTab` override reaches the notice
([validated by](../../tests/ChatMessage.test.tsx#L971)).
...
- **`MarkdownPolicy` fields are optional.** The issue's interface literal
  ...
  ([validated by](../../tests/ChatMessage.test.tsx#L943)).
...
- **Protocol-relative URLs never count as relative.** `//host`, `\\host` and
  ...
  by](../../tests/markdown/urlPolicy.test.tsx#L126)).
- **An allowed scheme without an authority is still a relative URL.** A
  ...
  by](../../tests/markdown/urlPolicy.test.tsx#L380),
  [L397](../../tests/markdown/urlPolicy.test.tsx#L397),
  [L409](../../tests/markdown/urlPolicy.test.tsx#L409)).
...
- **The factory sits in the `labelsProp` partition bucket** with its own
  ...
  ([validated by](../../tests/labelled-exports.test.tsx#L374),
  [L472](../../tests/labelled-exports.test.tsx#L472)).
...
- **Amendments to merged criteria, per the issue:** `ChatMessageProps` gains
  ...
  - The `@ts-expect-error` completeness fixture now omits the tenth key
    ([validated by](../../tests/types/chat-message-type-assertions.tsx#L73)).
...
- **Footnote references keep their attributes.** gfm footnote refs carry
  ...
  ([validated by](../../tests/markdown/urlPolicy.test.tsx#L347)).
- The default-policy objects are frozen, arrays included
  ([validated by](../../tests/markdown/urlPolicy.test.tsx#L362)).
