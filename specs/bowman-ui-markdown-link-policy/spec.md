...
`ReactMarkdown` ([validated by](../../tests/ChatMessage.test.tsx#L725),
[L754](../../tests/ChatMessage.test.tsx#L754),
[L766](../../tests/ChatMessage.test.tsx#L766)). A rejected link renders as a
span ([validated by](../../tests/ChatMessage.test.tsx#L741)). An image
renders as alt text
([validated by](../../tests/ChatMessage.test.tsx#L791)). The
`linkOpensInNewTab` override reaches the notice
([validated by](../../tests/ChatMessage.test.tsx#L779)).
...
- **`MarkdownPolicy` fields are optional.** The issue's interface literal
  ...
  ([validated by](../../tests/ChatMessage.test.tsx#L754)).
