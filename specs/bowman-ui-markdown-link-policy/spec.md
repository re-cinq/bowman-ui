...
`ReactMarkdown` ([validated by](../../tests/ChatMessage.test.tsx#L707),
[L736](../../tests/ChatMessage.test.tsx#L736),
[L748](../../tests/ChatMessage.test.tsx#L748)). A rejected link renders as a
span ([validated by](../../tests/ChatMessage.test.tsx#L723)). An image
renders as alt text
([validated by](../../tests/ChatMessage.test.tsx#L773)). The
`linkOpensInNewTab` override reaches the notice
([validated by](../../tests/ChatMessage.test.tsx#L761)).
...
- **`MarkdownPolicy` fields are optional.** The issue's interface literal
  ...
  ([validated by](../../tests/ChatMessage.test.tsx#L736)).
