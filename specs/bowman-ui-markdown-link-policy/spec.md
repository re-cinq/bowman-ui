...
`ReactMarkdown` ([validated by](../../tests/ChatMessage.test.tsx#L713),
[L737](../../tests/ChatMessage.test.tsx#L737),
[L754](../../tests/ChatMessage.test.tsx#L754)). A rejected link renders as a
span ([validated by](../../tests/ChatMessage.test.tsx#L724)). An image
renders as alt text
([validated by](../../tests/ChatMessage.test.tsx#L779)). The
`linkOpensInNewTab` override reaches the notice
([validated by](../../tests/ChatMessage.test.tsx#L767)).
...
- **The factory sits in the `labelsProp` partition bucket** with its own
  ...
  ([validated by](../../tests/labelled-exports.test.tsx#L393),
  [L477](../../tests/labelled-exports.test.tsx#L477)).
