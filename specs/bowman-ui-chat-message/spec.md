...
- **`InlineThinkingIndicator` takes `labels`, not a bare `label` string.** The
  ...
  decision 3 ([validated by](../../tests/InlineThinkingIndicator.test.tsx#L5),
  [partition](../../tests/labelled-exports.test.tsx#L53),
...
- **Sentinel harness content.** 022's sentinel test covers both components;
  ...
  ([validated by](../../tests/labelled-exports.test.tsx#L364), harness at
  [L236](../../tests/labelled-exports.test.tsx#L236)).
