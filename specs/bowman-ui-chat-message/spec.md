...
[validated by](../../tests/ChatMessage.test.tsx#L500)) and the indicator dots
(`bowman-fade-dot`) received
([validated by](../../tests/InlineThinkingIndicator.test.tsx#L18)).
...
([validated by](../../tests/ChatMessage.test.tsx#L327)).
...
- **`InlineThinkingIndicator` takes `labels`, not a bare `label` string.** The
  ...
  decision 3 ([validated by](../../tests/InlineThinkingIndicator.test.tsx#L11)).
