...
| e   | The streaming no-key-handling test passes `arrowKeyFeedback` ([L270](../../tests/ChatMessage.test.tsx#L270))                                                                                             | It must still exercise the `isStreaming` gate now that arrows are off by default                |
...
[validated by](../../tests/ChatMessage.test.tsx#L471)) and the indicator dots
(`bowman-fade-dot`,
[validated by](../../tests/InlineThinkingIndicator.test.tsx#L18)) received.
The tool-status row keeps `animate-spin` unchanged
([validated by](../../tests/ChatMessage.test.tsx#L295)): that is a Tailwind
...
- **Sentinel harness content.** 022's sentinel test covers both components;
  ...
  ([validated by](../../tests/labelled-exports.test.tsx#L219)).
