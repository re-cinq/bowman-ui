...
`scores` gone ([validated by](../../tests/ChatMessage.test.tsx#L670)).
...
([validated by](../../tests/ChatMessage.test.tsx#L600),
...
- Markdown renders through 019's `markdownComponents` map with `remarkGfm`;
  ...
  [L634](../../tests/ChatMessage.test.tsx#L699)).
- Raw HTML in `entry.content` stays escaped text; `rehype-raw` appears in no
  ...
  [L622](../../tests/ChatMessage.test.tsx#L687),
...
- `footer` collapses the two dev-harness slots into one `ReactNode` rendered
  ...
  ([validated by](../../tests/ChatMessage.test.tsx#L568),
  [L513](../../tests/ChatMessage.test.tsx#L578),
  [L525](../../tests/ChatMessage.test.tsx#L590)).
...
- **`InlineThinkingIndicator` takes `labels`, not a bare `label` string.** The
  ...
  [partition](../../tests/labelled-exports.test.tsx#L62),
...
- **Sentinel harness content.** 022's sentinel test covers both components;
  ...
  ([validated by](../../tests/labelled-exports.test.tsx#L468), harness at
  [L253](../../tests/labelled-exports.test.tsx#L267)).
