...
- `tests/labelled-exports.test.tsx` - the export-partition test: every value export of
  ...
  pointer at `CONTRACT.md § Labels` ([validated by](../../tests/labelled-exports.test.tsx#L73)).
  ...
  ([validated by](../../tests/labelled-exports.test.tsx#L143)), with the sentinel set pinned to
  the default-labels keys ([validated by](../../tests/labelled-exports.test.tsx#L137)).
...
- **Partition is over value exports.** The partition test statically parses `export { ... }`
  ...
  members ([validated by](../../tests/labelled-exports.test.tsx#L106)).
