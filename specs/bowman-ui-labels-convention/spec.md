...
- A function-valued label - the convention's interpolation form - overrides like any other key
  ([validated by](../../tests/resolveLabels.test.ts#L34)).
- Neither argument is mutated and `Object.freeze`d defaults do not throw
  ([validated by](../../tests/resolveLabels.test.ts#L43),
  [L55](../../tests/resolveLabels.test.ts#L55)).
...
- The three translated labels render with no English remaining; no `labels` prop renders the three
  021 English defaults unchanged ([validated by](../../tests/ErrorBoundary.test.tsx#L65),
...
- `eslint.config.mjs` gains a labels entry (core ESLint only): `no-restricted-syntax` selectors
  ...
  `next-intl` ([validated by](../../tests/eslint-labels.test.ts#L67),
  [L135](../../tests/eslint-labels.test.ts#L135),
  [L144](../../tests/eslint-labels.test.ts#L144),
  [L162](../../tests/eslint-labels.test.ts#L162)).
...
- The sentinel test renders every `labelsProp` member (today: `ErrorBoundary`, error state) with
  ...
  the default-labels keys ([validated by](../../tests/labelled-exports.test.tsx#L607),
  [L489](../../tests/labelled-exports.test.tsx#L489)).
- **The check's own proof:** reverting 021's `labels` prop to a hardcoded
  ...
  ([validated by](../../tests/labelled-exports.test.tsx#L607)).
...
- Re-pinned prior behaviour (AC 39): `<LoadingIcon ariaLabel="Cargando" />` renders
  ...
  ([validated by](../../tests/icons.test.tsx#L310),
  [announce](../../tests/useFocusGroups.test.tsx#L141)).
...
- **Behaviour change: explicit-`undefined` overrides.** 021's
  ...
  ([validated by](../../tests/ErrorBoundary.test.tsx#L89)).
