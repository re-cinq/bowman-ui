...
[L16](../../tests/AppSidebar.test.tsx#L16),
[L27](../../tests/AppSidebar.test.tsx#L27)). It passes the
...
2. **Active state is a per-item `isActive` boolean, not a path comparison.**
   ...
   - Three `navItems` render three items in order, each showing its `label`;
     ...
     ([validated by](../../tests/AppSidebar.test.tsx#L60),
     [L72](../../tests/AppSidebar.test.tsx#L72)).
   - Rows are keyed by `item.key`: reordering moves the same DOM nodes
     ([validated by](../../tests/AppSidebar.test.tsx#L87)).
   - `navItems` omitted or `[]` renders no `<nav>` element at all
     ([validated by](../../tests/AppSidebar.test.tsx#L100),
     [L106](../../tests/AppSidebar.test.tsx#L106)).
3. **`renderNavLink(item, props)` is the routing seam; the default is
   ...
   - The consumer's element must spread every prop it is handed -
     ...
     ([validated by](../../tests/AppSidebar.test.tsx#L131),
     [L154](../../tests/AppSidebar.test.tsx#L154),
     [L173](../../tests/AppSidebar.test.tsx#L173)).
   - Clicking an item calls `onNavigate` once with that item's `key`;
     `onNavigate` omitted, clicking throws nothing
     ([validated by](../../tests/AppSidebar.test.tsx#L112),
     [L123](../../tests/AppSidebar.test.tsx#L123)).
   - `icon` is an optional `ComponentType<{ className?: string }>` rendered at
     ...
     ([validated by](../../tests/AppSidebar.test.tsx#L181),
...
4. **The middle region is `children`, wrapped in
   ...
   ([validated by](../../tests/AppSidebar.test.tsx#L200)).
5. **The footer is one `footer?: ReactNode` slot inside a single `border-t`
   ...
   no such region ([validated by](../../tests/AppSidebar.test.tsx#L215),
   [L224](../../tests/AppSidebar.test.tsx#L224)).
6. **The brand is a slot inside the bordered top row; omitted, no row
   ...
   ([validated by](../../tests/AppSidebar.test.tsx#L230),
   [L240](../../tests/AppSidebar.test.tsx#L240)).
...
7. **One class list serves both 030 positions.** Below `md` the only
   ...
   ([validated by](../../tests/AppSidebar.test.tsx#L38)).
...
([validated by](../../tests/AppSidebar.test.tsx#L253)). The suite-wide
...
[L257](../../tests/AppSidebar.test.tsx#L257)). A key added to
