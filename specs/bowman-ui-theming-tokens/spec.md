...
([validated by](../../tests/theming-tokens-dist.test.ts#L274)).
...
- The set of tokens read across `dist/theme/tokens.js` and `dist/styles.css` is exactly the
  ...
  ([validated by](../../tests/theming-tokens-dist.test.ts#L189)).
...
- Every `--bowman-*` occurrence outside the declaration block is a `var()` read carrying a
  non-empty fallback ([validated by](../../tests/theming-tokens-dist.test.ts#L195)).
- A token falls back to the same palette value at every site that reads it, and that value is
  ...
  ([validated by](../../tests/theming-tokens-dist.test.ts#L209)).
- No bare `blue-` palette utility survives in any built component, the tokens module or the
  ...
  ([validated by](../../tests/theming-tokens-dist.test.ts#L257)).
...
value ([validated by](../../tests/theming-tokens-dist.test.ts#L278),
[L289](../../tests/theming-tokens-dist.test.ts#L289)).

- `dist/theme/tokens.js` carries no `"use client"` directive, and `dist/index.js` re-exports
  nothing from it ([validated by](../../tests/theming-tokens-dist.test.ts#L269)).
...
- `ChatMessage`'s streaming avatar circle reads `--bowman-accent-border` and
  ...
  ([validated by](../../tests/ChatMessage.test.tsx#L476)).
...
- Every focus ring keeps its `focus:ring-2` width class beside the `--bowman-focus-ring`
  ...
  ([validated by](../../tests/ChatMessage.test.tsx#L484),
...
- `bowman-pulse-subtle`'s 50 % stop reads `--bowman-accent-glow` and `--bowman-pulse-outline`
  ...
  [L226](../../tests/theming-tokens-dist.test.ts#L226)).
...
utility fails ([validated by](../../tests/theming-tokens-dist.test.ts#L238)).
...
- The `ChatComposer` textarea, `SearchField` input, `ErrorBoundary` heading, active `AppSidebar`
  ...
  ([validated by](../../tests/theming-tokens-dist.test.ts#L238), [L493](../../tests/ChatMessage.test.tsx#L493)).
- `ChatMessage`'s assistant name, the `ThinkingTrace` trace content and the `ToolActivity` tool
  ...
  ([validated by](../../tests/theming-tokens-dist.test.ts#L238),
  [L510](../../tests/ChatMessage.test.tsx#L510),
...
- `ChatMessage`'s copy and thumb buttons read `--bowman-text-subtle` at rest and
  ...
  slate-400 ([validated by](../../tests/theming-tokens-dist.test.ts#L238),
  [L516](../../tests/ChatMessage.test.tsx#L516),
...
3. **The keyframe's zero stop stays the literal `rgba(59, 130, 246, 0)`.** A review finding
   ...
   ([validated by](../../tests/theming-tokens-dist.test.ts#L226)).
4. **`--bowman-accent` falls back to blue-500 in light mode and blue-600 in dark, with the hover
   ...
   selector ([validated by](../../tests/theming-tokens-dist.test.ts#L209)).
...
[L71](../../tests/styles.test.ts#L71), [L476](../../tests/ChatMessage.test.tsx#L476)).
