...
docs/design-notes.md § Theming; this file pins the forty-three names, their fallbacks, every site
that reads them, and the tests.

## The tokens

Forty-three tokens - fifteen theme tokens named for a role and a shade, twenty neutral
...
`src/styles.css` ([validated by](../../tests/theming-tokens-dist.test.ts#L188)).
...
([validated by](../../tests/theming-tokens-dist.test.ts#L280)).

- The set of tokens read across `dist/theme/tokens.js` and `dist/styles.css` is exactly the
  forty-three the comment block declares - no forty-fourth name in the code, no orphan in the block
  ([validated by](../../tests/theming-tokens-dist.test.ts#L195)).
...
- Every `--bowman-*` occurrence outside the declaration block is a `var()` read carrying a
  non-empty fallback ([validated by](../../tests/theming-tokens-dist.test.ts#L201)).
- A token falls back to the same palette value at every site that reads it, and that value is
  ...
  ([validated by](../../tests/theming-tokens-dist.test.ts#L215)).
- No bare `blue-` palette utility survives in any built component, the tokens module or the
  ...
  ([validated by](../../tests/theming-tokens-dist.test.ts#L263)).
...
value ([validated by](../../tests/theming-tokens-dist.test.ts#L284),
[L295](../../tests/theming-tokens-dist.test.ts#L295)).

- `dist/theme/tokens.js` carries no `"use client"` directive, and `dist/index.js` re-exports
  nothing from it ([validated by](../../tests/theming-tokens-dist.test.ts#L275)).
...
- `bowman-pulse-subtle`'s 50 % stop reads `--bowman-accent-glow` and `--bowman-pulse-outline`
  ...
  [L232](../../tests/theming-tokens-dist.test.ts#L232)).
...
utility fails ([validated by](../../tests/theming-tokens-dist.test.ts#L244)).
...
- The `ChatComposer` textarea, `SearchField` input, `ErrorBoundary` heading, active `AppSidebar`
  ...
  ([validated by](../../tests/theming-tokens-dist.test.ts#L244), [L495](../../tests/ChatMessage.test.tsx#L495)).
- `ChatMessage`'s assistant name, the `ThinkingTrace` trace content and the `ToolActivity` tool
  ...
  ([validated by](../../tests/theming-tokens-dist.test.ts#L244),
...
- `ChatMessage`'s copy and thumb buttons read `--bowman-text-subtle` at rest and
  ...
  slate-400 ([validated by](../../tests/theming-tokens-dist.test.ts#L244),
...
- The selected thumbs-down chip and text, the `ErrorBoundary` icon circle and glyph, and the
  ...
  ([validated by](../../tests/theming-tokens-dist.test.ts#L243),
...
- The copied check mark and the selected thumbs-up read `--bowman-success` for their text, and the
  ...
  ([validated by](../../tests/theming-tokens-dist.test.ts#L244), [L529](../../tests/ChatMessage.test.tsx#L529)).
...
3. **The keyframe's zero stop stays the literal `rgba(59, 130, 246, 0)`.** A review finding
   ...
   ([validated by](../../tests/theming-tokens-dist.test.ts#L232)).
4. **`--bowman-accent` falls back to blue-500 in light mode and blue-600 in dark, with the hover
   ...
   selector ([validated by](../../tests/theming-tokens-dist.test.ts#L215)).
...
([validated by](../../examples/chat-demo/tests/theming.spec.ts#L235)). The module
...
([validated by](../../examples/chat-demo/tests/theming.spec.ts#L173),
...
([validated by](../../examples/chat-demo/tests/theming.spec.ts#L243),
[preview](../../examples/chat-demo/src/docs/ThemingSection.tsx#L24)).

The override lives in `examples/chat-demo/src/custom-theme.css`, which sets all forty-three tokens
...
([validated by](../../examples/chat-demo/tests/theming.spec.ts#L166),
...
([validated by](../../examples/chat-demo/tests/theming.spec.ts#L243)). The demo commits touched
...
on the themed one ([validated by](../../examples/chat-demo/tests/theming.spec.ts#L123),
[L192](../../examples/chat-demo/tests/theming.spec.ts#L192)).
...
([validated by](../../examples/chat-demo/tests/theming.spec.ts#L155)). The unthemed
...
([validated by](../../examples/chat-demo/tests/theming.spec.ts#L110)).
...
- With the composer focused, its wrapper's `box-shadow` contains `rgba(183, 65, 14, 0.12)` -
  `--bowman-accent-glow`
  ([validated by](../../examples/chat-demo/tests/theming.spec.ts#L217)).
- The sidebar names Copperline Bicycles
  ([validated by](../../examples/chat-demo/tests/theming.spec.ts#L235)).
...
- The previews' entry streams forever, so their circles need no polling window: the default
  ...
  ([validated by](../../examples/chat-demo/tests/theming.spec.ts#L264)).
...
([validated by](../../examples/chat-demo/tests/theming.spec.ts#L166),
[L264](../../examples/chat-demo/tests/theming.spec.ts#L264),
[L217](../../examples/chat-demo/tests/theming.spec.ts#L217)). Not measured in Chromium at all
