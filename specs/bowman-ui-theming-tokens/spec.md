...
roles added under decision 6 - each with its default recorded once in a comment line at the top
of `src/styles.css` ([validated by](../../tests/theming-tokens-dist.test.ts#L172)).
...
([validated by](../../tests/theming-tokens-dist.test.ts#L264)).
...
- Every `--bowman-*` occurrence outside the declaration block is a `var()` read carrying a
  non-empty fallback ([validated by](../../tests/theming-tokens-dist.test.ts#L185)).
- A token falls back to the same palette value at every site that reads it, and that value is
  ...
  ([validated by](../../tests/theming-tokens-dist.test.ts#L199)).
- No bare `blue-` palette utility survives in any built component, the tokens module or the
  ...
  ([validated by](../../tests/theming-tokens-dist.test.ts#L247)).
...
value ([validated by](../../tests/theming-tokens-dist.test.ts#L268),
[L279](../../tests/theming-tokens-dist.test.ts#L279)).

- `dist/theme/tokens.js` carries no `"use client"` directive, and `dist/index.js` re-exports
  nothing from it ([validated by](../../tests/theming-tokens-dist.test.ts#L259)).
...
- `bowman-pulse-subtle`'s 50 % stop reads `--bowman-accent-glow` and `--bowman-pulse-outline`
  ...
  [L216](../../tests/theming-tokens-dist.test.ts#L216)).
...
utility fails ([validated by](../../tests/theming-tokens-dist.test.ts#L228)).
...
- The `ChatComposer` textarea, `SearchField` input, `ErrorBoundary` heading, active `AppSidebar`
  ...
  ([validated by](../../tests/theming-tokens-dist.test.ts#L228), [L490](../../tests/ChatMessage.test.tsx#L490)).
- The twenty role fallbacks are declared in the stylesheet block and the design-notes table
  ...
  ([validated by](../../tests/theming-tokens-dist.test.ts#L172),
  [L264](../../tests/theming-tokens-dist.test.ts#L264)).

## Semantic colour roles

Two semantic-colour roles carry a status meaning rather than neutral chrome (docs/design-notes.md
...
3. **The keyframe's zero stop stays the literal `rgba(59, 130, 246, 0)`.** A review finding
   ...
   ([validated by](../../tests/theming-tokens-dist.test.ts#L216)).
4. **`--bowman-accent` falls back to blue-500 in light mode and blue-600 in dark, with the hover
   ...
   selector ([validated by](../../tests/theming-tokens-dist.test.ts#L199)).
...
([validated by](../../examples/chat-demo/tests/theming.spec.ts#L225)). The module
...
([validated by](../../examples/chat-demo/tests/theming.spec.ts#L172),
...
([validated by](../../examples/chat-demo/tests/theming.spec.ts#L233),
...
([validated by](../../examples/chat-demo/tests/theming.spec.ts#L165),
...
([validated by](../../examples/chat-demo/tests/theming.spec.ts#L233)). The demo commits touched
...
on the themed one ([validated by](../../examples/chat-demo/tests/theming.spec.ts#L122),
[L191](../../examples/chat-demo/tests/theming.spec.ts#L191)).
...
([validated by](../../examples/chat-demo/tests/theming.spec.ts#L154)). The unthemed
...
([validated by](../../examples/chat-demo/tests/theming.spec.ts#L109)).
...
- The sidebar names Copperline Bicycles
  ([validated by](../../examples/chat-demo/tests/theming.spec.ts#L225)).
...
- The previews' entry streams forever, so their circles need no polling window: the default
  ...
  ([validated by](../../examples/chat-demo/tests/theming.spec.ts#L254)).
...
([validated by](../../examples/chat-demo/tests/theming.spec.ts#L165),
[L254](../../examples/chat-demo/tests/theming.spec.ts#L254),
[L207](../../examples/chat-demo/tests/theming.spec.ts#L207)). Not measured in Chromium at all
