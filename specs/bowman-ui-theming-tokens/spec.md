...
`src/styles.css` ([validated by dist/styles.css opens with one comment line per token, forty-four in all, each stating its default](../../tests/theming-tokens-dist.test.ts#L190)).
...
([validated by the token table in docs/design-notes.md § Theming lists the same forty-four names and fallbacks, in the declared order](../../tests/theming-tokens-dist.test.ts#L282)).
...
- Every `--bowman-*` occurrence outside the declaration block is a `var()` read carrying a
  non-empty fallback ([validated by](../../tests/theming-tokens-dist.test.ts#L203)).
- A token falls back to the same palette value at every site that reads it, and that value is
  ...
  ([validated by each token falls back to the same palette value at every site, matching the declared default](../../tests/theming-tokens-dist.test.ts#L217)).
- No bare `blue-` palette utility survives in any built component, the tokens module or the
  ...
  ([validated by no bare blue- palette utility survives in any built component, the tokens module or the stylesheet](../../tests/theming-tokens-dist.test.ts#L265)).
...
value ([validated by no built component carries a --bowman- literal; the class strings live only in dist/theme/tokens.js](../../tests/theming-tokens-dist.test.ts#L286),
[validated by `no dist file assigns a --bowman-* value: every occurrence outside the stylesheet's comment block is a read`](../../tests/theming-tokens-dist.test.ts#L297)).

- `dist/theme/tokens.js` carries no `"use client"` directive, and `dist/index.js` re-exports
  nothing from it ([validated by dist/theme/tokens.js carries no "use client" directive and dist/index.js re-exports nothing from it](../../tests/theming-tokens-dist.test.ts#L277)).
...
- `ChatComposer`'s send button reads `--bowman-accent` for its background and
  ...
  ([validated by the send button reads --bowman-accent for its background and --bowman-accent-hover on hover, light and dark](../../tests/ChatComposer.test.tsx#L255)).
- `ChatComposer`'s send button and the primary `Button`/`IconButton` variant paint their text
  ...
  accent can darken it ([validated by the send button reads --bowman-text-on-accent for its text, one value in both modes](../../tests/ChatComposer.test.tsx#L273),
...
- `ChatComposer`'s wrapper keeps `focus-within:ring-2` beside the `--bowman-focus-ring` ring
  ...
  ([validated by the wrapper keeps focus-within:ring-2 beside the --bowman-focus-ring /50 ring and the --bowman-accent-glow shadow](../../tests/ChatComposer.test.tsx#L279)).
...
- `bowman-pulse-subtle`'s 50 % stop reads `--bowman-accent-glow` and `--bowman-pulse-outline`
  ...
  [validated by the keyframe's 50% stop reads --bowman-accent-glow and --bowman-pulse-outline while its zero stop stays literal](../../tests/theming-tokens-dist.test.ts#L234)).
...
utility fails ([validated by each neutral role constant is imported by exactly the built components recorded for it](../../tests/theming-tokens-dist.test.ts#L246)).
...
- The `ChatComposer` textarea, `SearchField` input, `ErrorBoundary` heading, active `AppSidebar`
  ...
  ([validated by each neutral role constant is imported by exactly the built components recorded for it](../../tests/theming-tokens-dist.test.ts#L246), [validated by the message body reads the strong text token, joining text-strong rather than text-body per decision 6](../../tests/ChatMessage.test.tsx#L511)).
...
- `ChatMessage`'s copy and thumb buttons read `--bowman-text-subtle` at rest and
  ...
  slate-400 ([validated by each neutral role constant is imported by exactly the built components recorded for it](../../tests/theming-tokens-dist.test.ts#L246),
...
- The twenty-one role fallbacks are declared in the stylesheet block and the design-notes table
  ...
  ([validated by dist/styles.css opens with one comment line per token, forty-four in all, each stating its default](../../tests/theming-tokens-dist.test.ts#L190),
  [validated by the token table in docs/design-notes.md § Theming lists the same forty-four names and fallbacks, in the declared order](../../tests/theming-tokens-dist.test.ts#L282)).
...
- The copied check mark and the selected thumbs-up read `--bowman-success` for their text, and the
  ...
  ([validated by each neutral role constant is imported by exactly the built components recorded for it](../../tests/theming-tokens-dist.test.ts#L246), [validated by the copied check and the selected thumbs-up read the success role, retiring the green literals](../../tests/ChatMessage.test.tsx#L545)).
...
- The ring width, offset and outline classes - `focus:ring-2`, `ring-offset-2`,
  ...
  `ring-offset-2` left in place ([validated by the wrapper keeps focus-within:ring-2 beside the --bowman-focus-ring /50 ring and the --bowman-accent-glow shadow](../../tests/ChatComposer.test.tsx#L279),
...
4. **`--bowman-accent` falls back to blue-500 in light mode and blue-600 in dark, with the hover
   ...
   selector ([validated by each token falls back to the same palette value at every site, matching the declared default](../../tests/theming-tokens-dist.test.ts#L217)).
