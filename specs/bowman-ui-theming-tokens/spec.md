...
`src/styles.css` ([validated by](../../tests/theming-tokens-dist.test.ts#L190)).
...
([validated by](../../tests/theming-tokens-dist.test.ts#L282)).
...
- The set of tokens read across `dist/theme/tokens.js` and `dist/styles.css` is exactly the
  ...
  ([validated by](../../tests/theming-tokens-dist.test.ts#L197)).
...
value ([validated by](../../tests/theming-tokens-dist.test.ts#L286),
[L297](../../tests/theming-tokens-dist.test.ts#L297)).

- `dist/theme/tokens.js` carries no `"use client"` directive, and `dist/index.js` re-exports
  nothing from it ([validated by](../../tests/theming-tokens-dist.test.ts#L277)).
...
- `bowman-pulse-subtle`'s 50 % stop reads `--bowman-accent-glow` and `--bowman-pulse-outline`
  ...
  [L234](../../tests/theming-tokens-dist.test.ts#L234)).
- `Button`'s and `IconButton`'s `primary` variant carries the `--bowman-accent` background and
  ...
  `--bowman-focus-ring` colour ([validated by](../../tests/Button.test.tsx#L96),
  [L120](../../tests/Button.test.tsx#L120), [L96](../../tests/IconButton.test.tsx#L96),
...
utility fails ([validated by](../../tests/theming-tokens-dist.test.ts#L246)).
...
3. **The keyframe's zero stop stays the literal `rgba(59, 130, 246, 0)`.** A review finding
   ...
   ([validated by](../../tests/theming-tokens-dist.test.ts#L234)).
4. **`--bowman-accent` falls back to blue-500 in light mode and blue-600 in dark, with the hover
   ...
   selector ([validated by](../../tests/theming-tokens-dist.test.ts#L217)).
...
([validated by](../../examples/chat-demo/tests/theming.spec.ts#L243)). The module
...
([validated by](../../examples/chat-demo/tests/theming.spec.ts#L251),
...
([validated by](../../examples/chat-demo/tests/theming.spec.ts#L251)). The demo commits touched
...
on the themed one ([validated by](../../examples/chat-demo/tests/theming.spec.ts#L128),
...
([validated by](../../examples/chat-demo/tests/theming.spec.ts#L160)). The unthemed
...
([validated by](../../examples/chat-demo/tests/theming.spec.ts#L111)).
