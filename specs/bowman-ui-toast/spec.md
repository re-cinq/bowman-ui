...
[L135](../../tests/Toast.test.tsx#L132)).
...
([validated by](../../tests/Toast.test.tsx#L84)). `message` renders inside
...
([validated by](../../tests/Toast.test.tsx#L31),
[L43](../../tests/Toast.test.tsx#L40)).
...
`onCloseRef.current()` ([validated by](../../tests/Toast.test.tsx#L102)):
...
- **The divergence.** A new `onClose` identity at 1000ms does not restart
  ...
  [validated by](../../tests/Toast.test.tsx#L102)).
- A different `message` on the same instance restarts the countdown:
  ...
  ([validated by](../../tests/Toast.test.tsx#L118)).
...
deadline never calls it ([validated by](../../tests/Toast.test.tsx#L48),
[L62](../../tests/Toast.test.tsx#L59),
[L73](../../tests/Toast.test.tsx#L70)).
...
[L51](../../tests/Toast.test.tsx#L48),
[L62](../../tests/Toast.test.tsx#L59),
[L73](../../tests/Toast.test.tsx#L70)). One deliberate naming decision:

| #   | Decision                                                                                                                                                                                                       | Reason                                                                                                                                              |
| --- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- |
| a   | The class assertion pins `bowman-toast-fade-in` plus the positioning classes, asserted on the visible pill since the 2026-08-26 review split it from the status region ([L87](../../tests/Toast.test.tsx#L84)) | 019's CSS naming rule - every package animation class ships under the `bowman-` prefix so it cannot collide with a consumer's `animate-*` utilities |

The divergence, message-restart and duration-null tests pin the
re-render-proof timer behaviour
([validated by](../../tests/Toast.test.tsx#L102),
[L121](../../tests/Toast.test.tsx#L118),
[L135](../../tests/Toast.test.tsx#L132)).
...
([validated by](../../tests/Toast.test.tsx#L163)).
...
- No `@clerk`, `swr`, `next-intl`, `next/` or `@/` import,
  ...
  ([validated by](../../tests/Toast.test.tsx#L152)).
- **GDPR.** `message` is caller-supplied and in the support agent may quote
  ...
  ([validated by](../../tests/Toast.test.tsx#L159)).
