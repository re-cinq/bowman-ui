...
([validated by](../../tests/AppShell.test.tsx#L82)).
...
([validated by](../../tests/AppShell.test.tsx#L25),
[L39](../../tests/AppShell.test.tsx#L39)). The skip link is the
...
([validated by](../../tests/AppShell.test.tsx#L54),
[L70](../../tests/AppShell.test.tsx#L70)).
...
([validated by](../../tests/labelled-exports.test.tsx#L589)). `AppShell`
...
[harness](../../tests/labelled-exports.test.tsx#L447)).
...
renders the frame ([validated by](../../tests/AppShell.test.tsx#L82),
[L95](../../tests/AppShell.test.tsx#L95)). The
mobile copy needs `close` so tapping a nav item closes the drawer - the same
slot idiom as `ConversationList`'s `renderLink`
([validated by](../../tests/AppShell.test.tsx#L138)). `close` is handed to
...
imports no logo ([validated by](../../tests/AppShell.test.tsx#L456),
[L469](../../tests/AppShell.test.tsx#L469),
[L477](../../tests/AppShell.test.tsx#L477)).
...
([validated by](../../tests/AppShell.test.tsx#L103),
[L120](../../tests/AppShell.test.tsx#L120),
[L129](../../tests/AppShell.test.tsx#L129),
[L138](../../tests/AppShell.test.tsx#L138)).
...
([validated by](../../tests/AppShell.test.tsx#L159),
[L179](../../tests/AppShell.test.tsx#L179)). A controlling consumer owns
...
([validated by](../../tests/AppShell.test.tsx#L179)).
...
([validated by](../../tests/AppShell.test.tsx#L204),
[L225](../../tests/AppShell.test.tsx#L225)). The closed drawer carries none of
the three ([validated by](../../tests/AppShell.test.tsx#L215)). The hamburger
...
the button cannot perform ([validated by](../../tests/AppShell.test.tsx#L237)).
...
1. **`inert` replaces `aria-hidden` on the closed drawer.** `aria-hidden`
   ...
   CSS breakpoint ([validated by](../../tests/AppShell.test.tsx#L249),
   [L262](../../tests/AppShell.test.tsx#L262)).
2. **The scroll lock restores the prior overflow value.** Resetting
   ...
   ([validated by](../../tests/AppShell.test.tsx#L357),
   [L412](../../tests/AppShell.test.tsx#L412)). A
   ...
   ([validated by](../../tests/AppShell.test.tsx#L368)).
...
([validated by](../../tests/AppShell.test.tsx#L305),
[L313](../../tests/AppShell.test.tsx#L313),
[L334](../../tests/AppShell.test.tsx#L334)). Escape and tab-cycling come from
...
([validated by](../../tests/AppShell.test.tsx#L345)).
...
[L434](../../tests/AppShell.test.tsx#L434)).
...
| #   | Decision                                                                                                                                                                               | Reason                                                                                    |
| --- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- |
| a   | Children render in `<main id="main-content">`, and `mainContentId` makes the id a prop ([L25](../../tests/AppShell.test.tsx#L25))                                                      | The landing region stays addressable for skip links without hardcoding the id             |
| b   | The `renderSidebar` slot is called twice (rail and drawer) while the shell owns the header and drawer chrome ([L82](../../tests/AppShell.test.tsx#L82))                                | The slot is the dependency boundary; the shell ships without auth, i18n or router imports |
| c   | The drawer's open/close cycle is asserted on observable DOM state (`translate-x-0`/`inert`) through the menu-click / close-click sequence ([L103](../../tests/AppShell.test.tsx#L103)) | Real DOM state, not a stub attribute, is what a consumer's user experiences               |
| d   | The closed drawer carries `inert` ([L249](../../tests/AppShell.test.tsx#L249))                                                                                                         | `aria-hidden` over still-tabbable content is the defect `inert` exists to prevent         |
| e   | The scroll lock restores the prior `document.body.style.overflow` value ([L357](../../tests/AppShell.test.tsx#L357))                                                                   | Clobbering the value to `""` breaks a consumer that manages body overflow itself          |
...
- `MenuIcon`/`CloseIcon` come from 020's set; imports are relative with `.js`
  ...
  ([validated by](../../tests/AppShell.test.tsx#L489)).
- GDPR: the shell wraps a surface carrying customer questions and booking
  ...
  ([validated by](../../tests/AppShell.test.tsx#L483)).
- `dist/components/AppShell.js` opens with `"use client";` as its first
  ...
  [L14](../../tests/app-shell-dist.test.ts#L14)).
...
- **Header stacks at `z-40` under the drawer/backdrop's `z-50`** - a third
  ...
  ([validated by](../../tests/AppShell.test.tsx#L506)).
- **`brand={null}` renders no spacer**, same as omitting the prop - `null` is
  ...
  ([characterization test](../../tests/AppShell.test.tsx#L521)).
