...
| `--bowman-text-secondary`      | `var(--color-slate-600)` | `AppShell` drawer buttons, sidebar item, ghost button, `ErrorBoundary` body text, `ChatMessage` copy/thumb buttons on hover (light)                                           |
