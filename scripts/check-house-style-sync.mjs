...
// eslint.house-style.mjs and prettier.house-style.mjs - against the canonical
// files on lore's main branch. Both mirrors are .prettierignore'd, so lore is
// the format authority for their bytes and equality really is byte equality.
//
...
const MIRRORS = ["eslint.house-style.mjs", "prettier.house-style.mjs"];
