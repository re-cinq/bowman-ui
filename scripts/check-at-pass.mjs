#!/usr/bin/env node
// re-cinq/Otto#97: the mechanical half of the assistive-technology pass. CI
...
if (record === null) {
  fail([
    `no ${RECORD_DIRECTORY}/at-pass-*.md record exists; the package must not be published before a human has run the assistive-technology pass (re-cinq/Otto#97)`,
  ]);
}
