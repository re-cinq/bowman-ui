...
# i18n, meta-framework, or the banned icon library. Called against a
# consumer's install (consumer-app.sh) and against
# the repo's own install (the rsc CI job). docs/design-notes.md § RSC fixture: next is
