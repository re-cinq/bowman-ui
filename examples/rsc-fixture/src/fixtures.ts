...
export const fixtureUserEntry: UserChatEntry = {
  id: "fixture-user-1",
  role: "user",
  content: "Hej, kan jeg aendre min afgang for reservation VN-7305-KP til fredag?",
};
...
export const fixtureAssistantEntry: AssistantChatEntry = {
  ...
  role: "assistant",
  content:
    "Hej Karla! Reservation **VN-7305-KP** kan flyttes til fredag uden gebyr. Pladserne er de samme som foer.",
  isStreaming: false,
};
