  ...
  describe("GDPR and import hygiene", () => {
    ...
    describe("review fixes (issue 030)", () => {
      ...
      it("brand={null} renders no centring spacer — correctly characterized with header-row selector", () => {
        ...
        // Uses getHamburger().parentElement (the actual <div> header row) — the CSS selector
        // "header > div" finds nothing because the mobile header is a <div>, not <header>.
        render(
        ...
        // Guard: the vacuous header-div selector call must not survive in this file.
        // It found nothing in AppShell's rendered output (the mobile header is a <div>),
        // so the old characterization test relying on it was vacuously true.
