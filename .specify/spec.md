...
| Telemetry           | None — the package emits none ([validated by `GDPR: the file calls no console.*, localStorage, sessionStorage, fetch, sendBeacon or analytics, and holds no draft persistence`](../tests/ChatComposer.test.tsx#L545))                                                                                                                                                                                                      |
