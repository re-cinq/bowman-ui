...
1. **Message Rendering** — `ChatMessage` renders one chat entry as an avatared message with copy and feedback affordances ([validated by](../tests/ChatMessage.test.tsx#L76))
...
| State management    | Consumer ([validated by](../tests/ChatMessage.test.tsx#L689))                                                                                                                                                                                                                                                                                                |
| Routing             | Consumer                                                                                                                                                                                                                                                                                                                                                     |
...
1. **Presentational Only** — No side effects, API calls, or complex state logic. All behavior is props-driven. ([validated by](../tests/ChatMessage.test.tsx#L689), [L440](../tests/ConversationList.test.tsx#L440))
