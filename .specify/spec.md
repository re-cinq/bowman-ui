...
| Styling             | bowman-ui ships `./styles.css` and reads its theme colours through forty-three `--bowman-*` semantic tokens with palette fallbacks; consumer's Tailwind v4 build scans `dist` and may override the tokens ([validated by](../tests/styles.test.ts#L106), [source](../tests/tailwind-build.test.ts#L79), [tokens](../tests/theming-tokens-dist.test.ts#L214)) |
